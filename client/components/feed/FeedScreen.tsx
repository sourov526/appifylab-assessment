  ...
  useEffect(() => {
    async function loadFeed() {
      ...
      try {
        ...
        const message = caughtError instanceof ApiError ? caughtError.message : "Unable to load the feed";
        setError(message);
                      ...
                      {error ? (
                        <div className="_feed_inner_timeline_post_area _b_radious6 _padd_b24 _padd_t24 _mar_b16">
                          <div className="_feed_inner_timeline_content _padd_r24 _padd_l24">
                            <h4 className="_feed_inner_timeline_post_title">{error}</h4>
                          </div>
                        </div>
                      ) : null}
                      {isLoading ? (
                        <div className="_feed_inner_timeline_post_area _b_radious6 _padd_b24 _padd_t24 _mar_b16">
                          <div className="_feed_inner_timeline_content _padd_r24 _padd_l24">
                            <h4 className="_feed_inner_timeline_post_title">Loading feed...</h4>
                          </div>
                        </div>
                      ) : posts.length ? (
                        posts.map((post) => (
                        ...
                        <div className="_feed_inner_timeline_post_area _b_radious6 _padd_b24 _padd_t24 _mar_b16">
                          <div className="_feed_inner_timeline_content _padd_r24 _padd_l24">
                            <h4 className="_feed_inner_timeline_post_title">No posts yet. Create the first one.</h4>
                          </div>
                        </div>
                      )}
                      <div hidden>
