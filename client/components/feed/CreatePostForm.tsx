...
export function CreatePostForm({ currentUser, onCreated }: CreatePostFormProps) {
  ...
  async function handleSubmit(event: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      setError(caughtError instanceof Error ? caughtError.message : "Unable to create post");
    } finally {
      ...
      <div className="_feed_inner_text_area _b_radious6 _padd_b24 _padd_t24 _padd_r24 _padd_l24 _mar_b16">
        <div className="_feed_inner_text_area_box">
          ...
          <div className="form-floating _feed_inner_text_area_box_form">
            ...
            />
            <label className="_feed_textarea_label" htmlFor="feed-create-post">
              Write something ...
        ...
        <div className="mt-3">
          <label className="form-label small mb-2">Visibility</label>
          <select
        ...
        {error ? <p className="text-danger small mb-0 mt-3">{error}</p> : null}
        ...
        <div className="_feed_inner_text_area_bottom">
          <div className="_feed_inner_text_area_item">
            <div className="_feed_inner_text_area_bottom_photo _feed_common">
              <button type="button" className="_feed_inner_text_area_bottom_photo_link" onClick={openFilePicker}>
